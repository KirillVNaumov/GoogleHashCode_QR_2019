...
{
    std::list<char *>   list_1 = arr_to_list(first->tags);
    std::list<char *>   list_2 = arr_to_list(second->tags);    
    std::list<char *>::const_iterator i1 = list_1.begin();
    std::list<char *>::const_iterator i2 = list_2.begin();
    int     score;
